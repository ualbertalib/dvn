...
public class LdapLoginPage extends VDCBaseBean implements java.io.Serializable {
	...
	public void init() {
		...
		if (getVDCRequestBean().getCurrentVDC() != null) {
			defaultPage = protocol + "://" + request.getServerName() + serverPort + request.getContextPath() + "/dv/"
				+ getVDCRequestBean().getCurrentVDC().getAlias();
		} else {
	 ...
	 * 
	 * @param loginFailed
	 *            New value of property loginFailed.
	 */
	 ...
	 * 
	 * @param redirect
	 *            New value of property redirect.
	 */
	 ...
	 * 
	 * @param affiliateName
	 *            New value of property affiliateName.
	 */
	...
	private void setAffiliateNames() {
		...
		while (iterator.hasNext()) {
			...
			selectitem.setLabel(loginaffiliate.getName());
			selectitem.setValue(loginaffiliate.getUrl() + "?url=" + refererUrl);
			affiliateNames[i] = selectitem;
			i++;
		}
	}
	 ...
	 * 
	 * @param isAffiliates
	 *            New value of property isAffiliates.
	 */
	 ...
	 * 
	 * @param hiddenStudyId
	 *            New value of property hiddenStudyId.
	 */
